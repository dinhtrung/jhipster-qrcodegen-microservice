...
import com.ft.client.OAuth2InterceptedFeignConfiguration;
...
public class QrGenApp {

    private static final Logger log = LoggerFactory.getLogger(QrGenApp.class);

    private final Environment env;

    public QrGenApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(QrGenApp.class);
